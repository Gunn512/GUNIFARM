  ...
  const allReviews = [
    {
      ...
      stars: 5,
      feedback:
        "Rau củ quả rất tươi ngon, giao hàng nhanh chóng. Sẽ ủng hộ lâu dài!",
    },
    {
      id: 2,
      name: "Trần Minh Tuấn",
      ...
      stars: 5,
      feedback:
        "Sản phẩm chất lượng, đóng gói cẩn thận. Rất hài lòng với dịch vụ của Guni Farm.",
    },
    {
      id: 3,
      name: "Phạm Thị Yến",
      email: "yen.pt@hotmail.com",
      avatar: "IMG/avatar/8.jpg",
      stars: 4,
      feedback: "Đã thử nhiều loại sản phẩm và đều rất ưng ý. Giá cả hợp lý.",
    },
    {
      id: 4,
      name: "Lê Văn Lộc",
      email: "loc.lv@gmail.com",
      avatar: "IMG/avatar/9.jpg",
      stars: 5,
      feedback:
        "Dịch vụ khách hàng rất tốt, tư vấn nhiệt tình. Hạt giống nảy mầm đều.",
    },
    {
      id: 5,
      name: "Đặng Thị Mai",
      ...
      stars: 4,
      feedback:
        "Mua bộ dụng cụ làm vườn rất tiện lợi. Mong Guni Farm có thêm nhiều sản phẩm mới.",
    },
    {
      id: 6,
      name: "Vũ Đình Khiêm",
      email: "khiem.vd@gmail.com",
      avatar: "IMG/avatar/11.jpg",
      stars: 5,
      feedback:
        "Rau cải xoong tươi, sạch, nấu canh rất ngọt. Cảm ơn Guni Farm!",
    },
    {
      id: 7,
      name: "Hoàng Minh Đức",
      ...
      stars: 5,
      feedback:
        "Trái cây ở đây luôn tươi ngon, không bị dập. Giao hàng đúng hẹn.",
    },
    {
      id: 8,
      name: "Bùi Thị Lan",
      ...
      avatar: "IMG/avatar/7.jpg",
      stars: 4,
      feedback: "Sản phẩm phân bón hữu cơ hiệu quả, vườn rau phát triển tốt.",
    },
    {
      id: 9,
      name: "Ngô Văn Tình",
      email: "tinh.nv@gmail.com",
      avatar: "IMG/avatar/8.jpg",
      stars: 5,
      feedback:
        "Mua rau ở Guni Farm rất yên tâm, không lo hóa chất. Giao hàng nhanh và chuyên nghiệp.",
    },
  ];
