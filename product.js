...
// Lay phan tu tu DOM
const productListContainer = document.getElementById("product-fruit");
    ...
    const productCardHTML = `
            <div class="product-card" data-product-id="${product.id}">
                ...
                <div class="product-info">
                    ...
                    <p class="product-brand">Bran: <span class="brand-name">${
                      product.brand
                    }</span></p>
                    <p class="product-category">Loại: <span class="category-name">${
                      product.category
                    }</span></p>
...
function initialize() {
  fetch("product.json")
    ...
    .then((data) => {
      ...
      allProducts = data.filter((p) => p.type === "product");
